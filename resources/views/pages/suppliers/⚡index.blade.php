...
new #[Title('إدارة الموردين')] class extends Component {
    use WithPagination;
...
<div dir="rtl"
    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {{-- Modals --}}
        @can('suppliers.create') <livewire:supplier.create /> @endcan
        @can('suppliers.update') <livewire:supplier.edit /> @endcan
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1.5 mr-2.5">
                            عرض {{ $this->suppliers->firstItem() ?? 0 }} - {{ $this->suppliers->lastItem() ?? 0 }}
                            من أصل <span
                                class="font-medium text-gray-600 dark:text-gray-300">{{ $this->suppliers->total() }}</span>
                            مورد
                        </p>
                    </div>
                    <div class="relative">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" placeholder="بحث في الموردين ..."
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="bg-gray-50 dark:bg-gray-800/40 border-b border-gray-100 dark:border-gray-800">
                            ...
                            <th class="px-6 py-4 text-start text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:text-gray-700 dark:hover:text-gray-300 transition"
                                wire:click="sortByColumn('supplier_name')">
                                <div class="flex items-center gap-1">
                                    اسم المورد
                            ...
                            <th class="px-6 py-4 text-start text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:text-gray-700 dark:hover:text-gray-300 transition"
                                wire:click="sortByColumn('supplier_phone')">
                                <div class="flex items-center gap-1">
                                    الموبايل
                                    @if ($sortBy === 'supplier_phone')
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="{{ $sortDirection === 'asc' ? 'M5 15l7-7 7 7' : 'M19 9l-7 7-7-7' }}">
                                            </path>
                            ...
                            <th class="px-6 py-4 text-start text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:text-gray-700 dark:hover:text-gray-300 transition"
                                wire:click="sortByColumn('supplier_address')">
                                <div class="flex items-center gap-1">
                                    عنوان المورد
                                    @if ($sortBy === 'supplier_address')
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="{{ $sortDirection === 'asc' ? 'M5 15l7-7 7 7' : 'M19 9l-7 7-7-7' }}">
                                            </path>
                            ...
                            <tr wire:key="supplier-{{ $supplier->id }}"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            ...
                                            {{ mb_substr($supplier->supplier_name, 0, 2) }}
                                        </div>
                                        <div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                        ...
                                        <span
                                            class="text-sm truncate max-w-[220px]">{{ $supplier->supplier_phone }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                        ...
                                        <span
                                            class="text-sm truncate max-w-[220px]">{{ $supplier->supplier_address }}</span>
                                    </div>
                                </td>
                                    ...
                                    <div class="flex flex-col items-center gap-4">
                                        ...
                                        <div class="text-center">
                                            <p class="text-base font-semibold text-gray-700 dark:text-gray-300">لا يوجد
                                                موردين</p>
                                            <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">ابدأ بإضافة مورد
