        ...
        return Customer::query()
            ...
            ->when($this->search, function ($q) {
                $q->where(function ($query) {
                    $query->where('customer_name', 'like', "%{$this->search}%")->orWhere('contact_info', 'like', "%{$this->search}%");
                });
            })
            ->paginate(10);
    }
            ...
            <div class="space-y-1">
                <div class="flex items-center gap-3">
                    ...
                    <span
                        ...
                        {{ $this->totalCustomers }} إجمالي
                    </span>
                </div>
                <p class="text-sm text-gray-500 dark:text-gray-400 pr-5">
                    إدارة وتنظيم جميع العملاء بكفاءة عالية وإحصائيات دقيقة
                </p>
            </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1.5 mr-2.5">
                            ...
                            من أصل <span
                                class="font-medium text-gray-600 dark:text-gray-300">{{ $this->customers->total() }}</span>
                            عميل
                        </p>
                    </div>
                    <div class="relative">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" placeholder="بحث في العملاء ..."
                            ...
                            <tr wire:key="customer-{{ $customer->id }}"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                        ...
                                        <span
                                            class="text-sm truncate max-w-[220px]">{{ $customer->contact_info }}</span>
                                    </div>
                                </td>
