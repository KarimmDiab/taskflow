                            ...
                            <tr
                                ...
                                <td class="p-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        @endif
                                        <a href="{{ route('purchaseInvoices.show', $purchase) }}" wire:navigate
                                            class="p-2 text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 rounded-lg transition-all duration-200 hover:scale-110 active:scale-95"
