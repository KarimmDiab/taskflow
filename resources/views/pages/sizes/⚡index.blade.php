...
new #[Title('مقاسات التيشرتات')] class extends Component {
        ...
        return Size::query()
            ...
            ->when($this->search, function ($q) {
                $q->where(function ($query) {
                    $query->where('size_name', 'like', "%{$this->search}%");
                });
            })
    ...
    public function getTotalSizesProperty()
    {
        return Size::count();
    }
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h1
                                    ...
                                    إدارة مقاسات التيشرتات
                                </h1>
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    منصة متكاملة لإدارة وتنظيم جميع مقاسات التيشرتات بكفاءة عالية
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-blue-600 dark:text-blue-400">إجمالي المقاسات</p>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            @php
                                $lastUpdated = Size::latest('updated_at')->value('updated_at');
                            @endphp
                ...
                <div class="flex flex-col lg:flex-row lg:items-center gap-4 justify-between">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1.5 mr-3">
                            عرض {{ $this->sizes->firstItem() ?? 0 }} - {{ $this->sizes->lastItem() ?? 0 }}
                            من أصل <span
                                class="font-semibold text-gray-600 dark:text-gray-300">{{ $this->sizes->total() }}</span>
                            مقاس
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <select wire:model.live="perPage"
                            ...
                            <option value="10">10 مقاسات</option>
                            <option value="25">25 مقاس</option>
                            <option value="50">50 مقاس</option>
                            <option value="100">100 مقاس</option>
                        </select>
                    </div>
                </div>
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="bg-gray-50/80 dark:bg-gray-800/40 border-b border-gray-100 dark:border-gray-800">
                            ...
                            <th class="px-6 py-4 text-start text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:text-gray-700 transition group"
                                wire:click="sortByColumn('size_name')">
                                <div class="flex items-center gap-1">
                                    اسم المقاس
                                    @if ($sortBy === 'size_name')
                        ...
                        @forelse ($this->sizes as $size)
                            <tr wire:key="size-{{ $size->id }}"
                                ...
                                <td class="px-6 py-4 text-gray-400 dark:text-gray-600 text-xs font-mono font-medium">
                                    {{ $loop->iteration + ($this->sizes->currentPage() - 1) * $this->sizes->perPage() }}
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                        ...
                                        <span
                                            class="text-sm line-clamp-1 max-w-[250px]">{{ $size->sort_order }}</span>
                                    </div>
                                </td>
                                {{-- NEW CELL: الحالة --}}
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col gap-0.5">
                                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                            {{ $size->created_at->translatedFormat('d F Y') }}
                                        </span>
                                    ...
                                    <div class="flex flex-col items-center gap-4">
                                        ...
                                        <div class="text-center">
                                            <p class="text-lg font-semibold text-gray-700 dark:text-gray-300">لا توجد
                                                مقاسات</p>
                                            <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">ابدأ بإضافة مثاس
