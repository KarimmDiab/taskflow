...
<flux:modal name="add-size" class="md:w-[600px] overflow-hidden rounded-2xl" style="padding: 0;">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <flux:text class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        قم بإدخال تفاصيل المقاس لإضافته إلى النظام
                    </flux:text>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 space-y-6 bg-white dark:bg-zinc-900">
            ...
            <div>
                ...
                <flux:input
                    ...
                    style="border-width: 1px;"
                />
                <flux:text class="text-xs text-gray-400 mt-1">الأرقام الأصغر تظهر أولاً</flux:text>
