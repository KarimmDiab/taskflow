...
">
    ...
    ">
      ...
      <div>
        ...
        <p class="section-eyebrow reveal" style="
                    margin-bottom:24px;
        ...
        <h2 class="section-title reveal reveal-delay-1" style="
      ...
      <div class="reveal reveal-delay-2">
        ...
        <div style="
          ...
          <div>
            <p style="font-size:12px;letter-spacing:0.18em;text-transform:uppercase;color:#8A8A86; margin-bottom:10px;">
              Identity
            </p>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:32px 24px;">
      ...
      <div class="product-card reveal reveal-delay-1">
        <div class="product-img-wrap" style="aspect-ratio:3/4;">
          <img src="https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=600&q=80" alt="Oversized Tee">
          ...
          <button class="wishlist-btn" aria-label="Wishlist">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#0A0A0A" stroke-width="1.5">
              <path
      ...
      <div class="product-card reveal reveal-delay-2">
        <div class="product-img-wrap" style="aspect-ratio:3/4;">
          ...
          <img class="hover-img" src="https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=600&q=80"
            alt="Cargo alt">
          <span class="product-badge badge-new">New</span>
          <button class="wishlist-btn" aria-label="Wishlist">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#0A0A0A" stroke-width="1.5">
      ...
      <div class="product-card reveal reveal-delay-4">
        <div class="product-img-wrap" style="aspect-ratio:3/4;">
          ...
          <img class="hover-img" src="https://images.unsplash.com/photo-1578681994506-b8f463449011?w=600&q=80"
            alt="Hoodie alt">
          <button class="wishlist-btn" aria-label="Wishlist">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#0A0A0A" stroke-width="1.5">
              <path
...
═══════════════════════════════════════════ -->
  <section style="display:grid;grid-template-columns:1fr 1fr;max-width:1440px;margin:0 auto 0;gap:2px;" class="reveal">
    <!-- Left Banner -->
...
═══════════════════════════════════════════ -->
  <section style="padding:120px 40px;max-width:1440px;margin:0 auto;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:24px;">
      ...
      <div class="product-card reveal reveal-delay-1">
        <div class="product-img-wrap" style="aspect-ratio:3/4;">
          <img src="https://images.unsplash.com/photo-1594938298603-f4d8c9a3a9a4?w=500&q=80" alt="Best Seller 1">
      ...
      <div class="product-card reveal reveal-delay-2">
        <div class="product-img-wrap" style="aspect-ratio:3/4;">
          <img src="https://images.unsplash.com/photo-1542272604-787c3835535d?w=500&q=80" alt="Best Seller 2">
          <span class="product-badge badge-sale">Best Seller</span>
          <button class="wishlist-btn" aria-label="Wishlist">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#0A0A0A" stroke-width="1.5">
              <path
      ...
      <div class="product-card reveal reveal-delay-3">
        <div class="product-img-wrap" style="aspect-ratio:3/4;">
          <img src="https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=500&q=80" alt="Best Seller 3">
          <span class="product-badge badge-sale">Best Seller</span>
          <button class="wishlist-btn" aria-label="Wishlist">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#0A0A0A" stroke-width="1.5">
              <path
      ...
      <div class="product-card reveal reveal-delay-4">
        <div class="product-img-wrap" style="aspect-ratio:3/4;">
          <img src="https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=500&q=80" alt="Best Seller 4">
          <span class="product-badge badge-sale">Best Seller</span>
          <button class="wishlist-btn" aria-label="Wishlist">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#0A0A0A" stroke-width="1.5">
              <path
