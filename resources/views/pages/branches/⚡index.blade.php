...
new #[Title('إدارة الفروع')] class extends Component {
    use WithPagination;
        ...
        return Branches::query()
            ...
            ->when($this->search, function ($q) {
                $q->where(function ($query) {
                    $query->where('branch_name', 'like', "%{$this->search}%")->orWhere('branch_address', 'like', "%{$this->search}%");
                });
            })
    ...
    {
        abort_unless(auth()->user()?->can('branches.update'), 403);
...
<div dir="rtl"
    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    منصة متكاملة لإدارة وتنظيم جميع الفروع بكفاءة عالية
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-blue-600 dark:text-blue-400">إجمالي الفروع</p>
                                <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">
                                    {{ $this->totalBranches }}</p>
                            </div>
                            <div
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            @php
                                $lastUpdated = Branches::latest('updated_at')->value('updated_at');
                            @endphp
        ...
        {{-- Modals --}}
        @can('branches.create') <livewire:branch.create /> @endcan
        @can('branches.update') <livewire:branch.edit /> @endcan
                ...
                <div class="flex flex-col lg:flex-row lg:items-center gap-4 justify-between">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1.5 mr-3">
                            ...
                            من أصل <span
                                class="font-semibold text-gray-600 dark:text-gray-300">{{ $this->branches->total() }}</span>
                            فرع
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <select wire:model.live="perPage"
                            ...
                            <option value="25">25 فرع</option>
                            <option value="50">50 فرع</option>
                            <option value="100">100 فرع</option>
                        </select>
                    </div>
                </div>
                        ...
                        @forelse ($this->branches as $branch)
                            <tr wire:key="branch-{{ $branch->id }}"
                                ...
                                <td class="px-6 py-4 text-gray-400 dark:text-gray-600 text-xs font-mono font-medium">
                                    {{ $loop->iteration + ($this->branches->currentPage() - 1) * $this->branches->perPage() }}
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                        ...
                                        <span
                                            class="text-sm line-clamp-1 max-w-[250px]">{{ $branch->branch_address }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex flex-col gap-0.5">
                                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                            {{ $branch->created_at->translatedFormat('d F Y') }}
                                        </span>
