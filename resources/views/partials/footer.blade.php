  ...
  <footer style="background:#0A0A0A;border-top:1px solid #1a1a1a;padding:64px 40px 32px;">
      <div style="max-width:1440px;margin:0 auto;">
          ...
          <div style="display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:48px;margin-bottom:64px;">
              ...
              <div>
                  ...
                  <div style="display:flex;gap:16px;">
                      <a href="https://www.facebook.com/RYObrand.official" target="_blank"
              ...
              <div>
                  <p
                      ...
                      Info</p>
                  <nav style="display:flex;flex-direction:column;gap:12px;">
                      <a href="{{ route('about-us') }}" class="footer-link">About RYO</a>
          ...
          <div
              ...
              <p style="font-family:'DM Sans',sans-serif;font-size:12px;color:#3D3D3A;">© 2026 RYO. All rights reserved.
              </p>
              <div style="display:flex;gap:24px;">
                  <a href={{ route('privacy-policy') }} target="_blank"
                      ...
                      onmouseover="this.style.color='#9C9A96'" onmouseout="this.style.color='#3D3D3A'">Privacy
                      Policy</a>
                  <a href={{ route('terms-of-services') }} target="_blank"
                      style="font-family:'DM Sans',sans-serif;font-size:12px;color:#3D3D3A;text-decoration:none;transition:color 0.3s ease;"
                      onmouseover="this.style.color='#9C9A96'" onmouseout="this.style.color='#3D3D3A'">Terms of
                      Service</a>
                  <a href={{ route('Shipping-Policy') }} target="_blank"
                      style="font-family:'DM Sans',sans-serif;font-size:12px;color:#3D3D3A;text-decoration:none;transition:color 0.3s ease;"
                      onmouseover="this.style.color='#9C9A96'" onmouseout="this.style.color='#3D3D3A'">Shipping
                      Policy</a>
                  <a href={{ route('refund-policy') }} target="_blank"
                      style="font-family:'DM Sans',sans-serif;font-size:12px;color:#3D3D3A;text-decoration:none;transition:color 0.3s ease;"
                      onmouseover="this.style.color='#9C9A96'" onmouseout="this.style.color='#3D3D3A'">Refund Policy</a>
              </div>
          </div>
      </div>
  </footer>
