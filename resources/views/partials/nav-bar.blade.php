...
<div style="display:flex;align-items:center;gap:24px;">
  ...
  <div style="display:flex;align-items:center;gap:16px;">
    ...
    <button onclick="toggleCart()" class="nav-icon"
      style="background:none;border:none;cursor:pointer;color:#F8F6F2;transition:color 0.4s ease;padding:4px;position:relative;"
      aria-label="Cart">
      ...
      <span
        style="position:absolute;top:-2px;right:-4px;width:16px;height:16px;border-radius:50%;background:#F8F6F2;color:#0A0A0A;font-size:9px;font-family:'Space Grotesk',sans-serif;display:flex;align-items:center;justify-content:center;font-weight:500;"
        id="cartCount">2</span>
    </button>
    <!-- Hamburger (mobile) -->
